...
# Checked
./comparator4.sh tests4/file1.txt tests4/file1.txt > /dev/null 2>&1
check "1" "Files are equal and don't contain float numbers."

# Checked
./comparator4.sh tests4/file2.txt tests4/file3.txt > /dev/null 2>&1
check "0" "Files are different and don't contain float numbers, but contain equal\n" \
		  "integers."
...
check "0" "Files contain equal float numbers,numbers in scientific notation and\n" \
		  "integers, numbers in the words should be ignored."
...
check "0" "Files contain float numbers and numbers in scientific notation with\n" \
		  "leading zeros."
