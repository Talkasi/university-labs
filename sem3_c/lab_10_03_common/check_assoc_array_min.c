...
START_TEST(two_elems_first_min)
{
...
START_TEST(two_elems_second_min)
{
...
START_TEST(three_elems_first_min)
{
    const char *key1 = "key1";
    int num1 = 1;
...
START_TEST(three_elems_second_min)
{
    const char *key1 = "key1";
    int num1 = 1;
...
START_TEST(three_elems_third_min)
{
    const char *key1 = "key1";
    int num1 = 1;
...
Suite *assoc_array_min_suite()
{
    Suite *s;
    TCase *tc_core;

    s = suite_create("Min suite");
    tc_core = tcase_create("Min");

    tcase_add_test(tc_core, one_elem);
    tcase_add_test(tc_core, two_elems_first_min);
    tcase_add_test(tc_core, two_elems_second_min);
    tcase_add_test(tc_core, three_elems_first_min);
    tcase_add_test(tc_core, three_elems_second_min);
    tcase_add_test(tc_core, three_elems_third_min);
